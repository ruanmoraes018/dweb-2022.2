...
from .models import Passageiro, Motorista, Custom, RotaViagem
...
class SuperPassageiro(UserAdmin):
    ...
    list_display = ('username', 'email', 'nome_preferencia', 'is_staff', 'is_superuser')
    ...
    fieldsets = (
        ...
        (_('Informações Pessoais'), {'fields': ('nome_completo', 'nome_preferencia', 'cpf', 'telefone')}),
        (_('Informações de Endereço'), {'fields': ('cep', 'logradouro', 'numero_residencia', 'bairro', 'cidade', 'estado')}),
        (_('Permissions'), {
...
class SuperMotorista(UserAdmin):
    ...
    fieldsets = (
        ...
        (_('Informações Pessoais'), {'fields': ('nome_completo', 'nome_preferencia', 'cpf', 'telefone')}),
        (_('Informações de Endereço'), {'fields': ('cep', 'logradouro', 'numero_residencia', 'bairro', 'cidade', 'estado')}),
        (_('Informações de CNH'), {'fields': ('cnh', 'placa', 'renavam', 'chassi')}),
        (_('Permissions'), {
            'fields': ('is_active', 'is_staff', 'is_superuser', 'groups', 'user_permissions'),
        }),
    )
...
#     list_display = ('id', 'origem', 'destino', 'preco', 'horario_ida', 'horario_volta', 'dias_semana_list')

class RotaViagemAdmin(admin.ModelAdmin):
    list_display = ('id', 'origem', 'destino', 'preco', 'horario_ida', 'dias_semana_list', 'tipo_veiculo')
